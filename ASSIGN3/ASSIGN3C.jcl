...
*                                                               *
*        FUNCTION: ADDING REGISTERS 2 AND 3 USING EXPLICIT      *
*                  ADDRESSING. THEN USE XDUMP TO DUMP REGISTERS *
*****************************************************************
*
MAIN     CSECT
         USING MAIN,15     ESTABLISH ADDRESSABILITY ON REG 15
         L     2,28(,15)   EXPLICIT ADDRESSING ON REG 2
         L     3,24(,15)   EXPLICIT ADDRESSING ON REG 3
*
         SR    2,3         SUBTACT 3 FROM 2
         ST    4,32(,15)   STORE THE DIFFERENCE IN ANSWER
*
